...
password = "solidfire"              # Cluster admin password
node_ips = []                       # List of node IP addresses
ssh_user = "root"                   # Cluster node SSH username
ssh_pass = "Boronthe5thElement"     # Cluster node ssh password
...
client_pass = "solidfire"           # Client SSH password
...
email_from = "testscript@solidfire.com"     # Email address to send notifications from
...
host_pass = "solidfire"             # Hypervisor host password
...
esx_template_path = "cft-ubuntu-template-vdbench/cft-ubuntu-template-vdbench.vmtx"  # Path to the template VM image on NFS Datastore
esx_parent_folder = "CFT-Test-VMs"                                                  # Parent folder for CFT VMS
...
qmetry_password = "1f@stSSD"
qmetry_project = "Element"
qmetry_release = "Carbon"
qmetry_build = "C.6"

# FC project v1.0 defaults
fc_mgmt_server = "172.26.75.47"        # FC vSphere Server
fc_vsphere_user = "script"      # vSphere admin
fc_vsphere_pass = "solidfire"          # vSphere pass
